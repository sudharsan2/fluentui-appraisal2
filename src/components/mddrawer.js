...
const MDNavDrawerDefault = (props) => {
...
>
  ...
  {collapse ? (
    <NavDrawerBody
        style={themestate?{backgroundColor:darktheme.sidebarcolordark, cursor:"pointer",WebkitTapHighlightColor: 'transparent'}:{cursor:"pointer",WebkitTapHighlightColor: 'transparent'}}
     >
      <Tooltip content={'Approval'} positioning='after' withArrow={true} appearance={themestate?"inverted":"normal"}>
      <NavItem
        target="_blank"
        icon={<Dashboard style={themestate?{color:darktheme.fontcolordark}:{color:lighttheme.fontcolorlight}} />}
        onClick={() => someClickHandler('mdapproval')}
        value="1"
      ...
      <NavItem
        ...
        onClick={() => someClickHandler('mdsummary')}
        value="2"
        className={themestate? styles.navItemdark : styles.navItemlight}
      >
    ...
    >
      ...
      <NavItem
        ...
        >
        <div style={themestate?{marginTop:"2px" , color:darktheme.fontcolordark}:{marginTop:"2px" , color:lighttheme.fontcolorlight}}>Approval</div>
      </NavItem>
      </div>
      <div style={{width:'100%'} }>
      <NavItem
...
export default MDNavDrawerDefault;